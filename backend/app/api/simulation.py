...
def _check_simulation_prepared(simulation_id: str) -> tuple:
    ...
    # Required file list (excludes scripts, which are located in backend/scripts/)
    required_files = [
        "state.json",
    ...
    try:
        ...
        # - running: currently running, meaning preparation was done long ago
        # - completed: run complete, meaning preparation was done long ago
        # - stopped: stopped, meaning preparation was done long ago
...
def prepare_simulation():
    ...
    2. Read and filter entities from the graph
    ...
    try:
        ...
        try:
            ...
            reader = ZepEntityReader()
            # Quick read of entities (no edge info needed, just counting)
...
def start_simulation():
    ...
    About the force parameter:
        ...
        - Suitable for scenarios requiring a simulation re-run

    About enable_graph_memory_update:
        - When enabled, all Agent activities (posts, comments, likes, etc.) are updated to the graph in real-time
    ...
    try:
        ...
        if state.status != SimulationStatus.READY:
            ...
            if is_prepared:
                ...
                # Preparation work is not complete
                return jsonify({
                    "success": False,
